    ...
    <group ref={group} {...props} dispose={null} scale={[1.2, 1.2, 1.2]} >
      <group name="Scene">
        ...
        <group name="Empty" position={[-15.695, -2.238, 0.98]} rotation={[Math.PI / 2, 0, -Math.PI / 2]} scale={1.726}>
          <group name="Cube003" position={[-0.139, 0, -0.555]} rotation={[-Math.PI / 2, 0, Math.PI]} scale={-0.579}>
            <mesh name="Cube001_1" geometry={nodes.Cube001_1.geometry} material={materials['Material.001']} />
            <mesh name="Cube001_2" geometry={nodes.Cube001_2.geometry} material={materials['Material.002']} />
            <mesh name="Cube001_3" geometry={nodes.Cube001_3.geometry} material={materials.Material} />
            <mesh name="Cube001_4" geometry={nodes.Cube001_4.geometry} material={materials['Material.006']} />
            <mesh name="Cube001_5" geometry={nodes.Cube001_5.geometry} material={materials['Material.003']} />
          </group>
        </group>
        <group name="Empty002" position={[-15.695, -2.241, 4.602]} rotation={[Math.PI / 2, 0, -Math.PI / 2]}>
          <group name="Cube002" position={[-0.019, 0, -1.494]} rotation={[-Math.PI / 2, 0, 0]} scale={[1, 1, 0.928]}>
            ...
            <mesh name="Cube006_3" geometry={nodes.Cube006_3.geometry} material={materials['Material.005']} />
            <mesh name="Cube006_4" geometry={nodes.Cube006_4.geometry} material={materials['Material.003']} />
          </group>
        </group>
        <mesh name="KakaoTalk_20250301_145139734" geometry={nodes.KakaoTalk_20250301_145139734.geometry} material={materials.KakaoTalk_20250301_145139734} position={[0, -2.305, 0]} rotation={[0, Math.PI / 2, 0]} scale={[-34.935, -27.566, -34.935]} />
