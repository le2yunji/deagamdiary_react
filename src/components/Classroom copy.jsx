...
export const Classroom = forwardRef(({ onLoaded, ...props }, ref) => {
  ...
  const { nodes, materials, animations  } = useGLTF('/assets/models/ClassroomAnim.glb')
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <group name="Empty" position={[0, 1.536, 0.458]} scale={[0.1, 0.098, 0.094]}>
          ...
          <group name="Chairrim001" position={[-0.317, 0.98, -2]} scale={[-0.031, -0.031, -0.033]}>
          ...
          <group name="Chairrim002" position={[0.467, 0.98, -2]} scale={[-0.031, -0.031, -0.033]}>
          ...
          <group name="Chairrim003" position={[1.25, 0.98, -2]} scale={[-0.031, -0.031, -0.033]}>
          ...
          <group name="Chairrim004" position={[-0.317, 0.98, 1]} scale={[-0.031, -0.031, -0.033]}>
          ...
          <group name="Chairrim005" position={[0.467, 0.98, 1.148]} scale={[-0.031, -0.031, -0.033]}>
          ...
          <group name="Chairrim006" position={[1.25, 0.98, 1.148]} scale={[-0.031, -0.031, -0.033]}>
          ...
          <group name="Photo1" position={[-1.352, 1.177, -0.52]} rotation={[-2.039, 1.556, 2.058]} scale={[0.227, 0.216, 0.212]}>
          ...
          <group name="Photo1001" position={[-1.352, 1.227, -1.19]} rotation={[-1.161, 1.551, 1.056]} scale={[0.215, 0.205, 0.201]}>
          ...
          <group name="Photo1002" position={[-1.352, 0.851, 0.092]} rotation={[-1.4, 1.565, 1.514]} scale={[0.197, 0.188, 0.184]}>
          ...
          <group name="Plane001" position={[-1.126, 0.481, 0.021]} rotation={[0.032, -0.508, -1.548]} scale={[0.892, 0.891, 0.922]}>
...
useGLTF.preload('/assets/models/ClassroomAnim.glb')
